...
public class IntroUpdate2Activity extends AppIntro {
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        addSlide(AppIntroFragment.newInstance(
                getString(R.string.appupdate_2_slide_1_title),
                getString(R.string.appupdate_2_slide_1_description),
                R.drawable.graphs_update,
